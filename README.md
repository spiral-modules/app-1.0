...
The Spiral framework provides open and modular Rapid Application Development (RAD), database tools, code re-usability, extremely friendly [IoC](https://github.com/container-interop/container-interop), PSR-7, simple syntax and customizable scaffolding mechanisms
