...
Spiral will take care of database abstractions, ORM, MongoDB, working with Amazon or Rackspace, Views and Templates, etc. It will help to mount external libraries by providing simple API or design your application using Services and DataEntities.
