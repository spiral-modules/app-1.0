...
The Spiral framework provides a modular Rapid Application Development (RAD) platform to develop web applications using an HMVC or curstom application architecture, modern practices, PSR-7, simple syntax and scaffolding mechanisms (use existed or write your own).
